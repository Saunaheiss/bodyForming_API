...
insert into trainer_user(id,first_name, last_name, email, password, personal_photo, conclusion, philosophy) values(4,'Jonathan', 'Klinsmann', 'jonathan.klinsmann@t-online.de', 'testpw', 'https://upload.wikimedia.org/wikipedia/de/1/16/Klinsmann_Jonathan.jpg', 'Jonathan Klinsmann (* 8. April 1997 in München) ist ein deutsch-US-amerikanischer Fußballtorwart. Er steht beim Bundesligisten Hertha BSC unter Vertrag.', 'Meine Philosophie ist wie jeder mag');

insert into trainer_user_experience(trainer_user_id, experience) values (4, 'Medizinstudium');
insert into trainer_user_experience(trainer_user_id, experience) values (4, 'Discopumper für 5 Jahre');

insert into trainer_user_photos(trainer_user_id, photos) values (4, 'http://i.eurosport.com/2017/07/07/2123371-44424638-640-360.jpg');
insert into trainer_user_photos(trainer_user_id, photos) values (4, 'http://img.fifa.com/mm/photo/tournament/competition/02/88/91/94/2889194_full-lnd.jpg');
